...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='./datasets/facades',      # required=True
        ...
        parser.add_argument('--netD1', type=str, default='spatch', help='selects model to use for netD')
        parser.add_argument('--netD2', type=str, default='basic', help='selects model to use for netD')
