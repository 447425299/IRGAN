...
import numpy as np
from .convnext import uconvnext
    ...
    def __call__(self, input, target_is_real):
        if isinstance(input[0], list):
            ...
            for input_i in input:
                ...
                target_tensor = self.get_target_tensor(pred, target_is_real).to(device)
...
class Gradient_Net(nn.Module):
    def __init__(self):
        ...
        kernel_y = [[[-1., -2., -1.], [0., 0., 0.], [1., 2., 1.]], [[-1., -2., -1.], [0., 0., 0.], [1., 2., 1.]],
                    [[-1., -2., -1.], [0., 0., 0.], [1., 2., 1.]]]
...
class SobelLoss(nn.Module):
    def __init__(self):
        ...
        self.Gradient_Net = Gradient_Net().cuda()
        self.criterion = nn.L1Loss()

    def forward(self, x, y):
        x_sobel, y_sobel = self.Gradient_Net(x), self.Gradient_Net(y)
        loss = self.criterion(x_sobel, y_sobel.detach())
        return loss
